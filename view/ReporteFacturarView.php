...
<html lang="es">
        	   ...
        	   function load_marcaciones(pagina){
                 ...
                 $("#load_marcaciones_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=ReportesFacturas&action=marcaciones&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
        	   ...
        	   function load_aprobadas(pagina){
                 ...
                 $("#load_aprobadas_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=ReportesFacturas&action=aprobadas&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
    ...
    <div class="container">
		...
		<div class="col-md-12 col-lg-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Panel<small>Facturas</small></h2>
                  ...
                  <div class="x_content">
                   ...
                   <div class='nav-tabs-custom'>
                    ...
                    <li id="nav-servicios" class="active"><a href="#servicios" data-toggle="tab">Servicios Instalación Facturados</a></li>
                     <li id="nav-consumo"><a href="#consumo" data-toggle="tab" >Consumo Agua Potable Facturados</a></li>
                   </ul>
