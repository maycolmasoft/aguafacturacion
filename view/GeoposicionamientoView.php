      ...
      $marcadores ="";
        ...
        if (!empty($resultSet)) { 
        	...
        	foreach($resultSet as $res) {
        		...
        		$marcadores.="['";
        		$marcadores.=$res->razon_social_clientes."',".$res->lat.",".$res->lng.",'".$res->identificador_medidores_agua."','".$res->formato_direccion_clientes."'],";
    ...
    function initialize()  {
     ...
     /* var marcadores = [
      ...
      for (i = 0; i < marcadores.length; i++) {  
        ...
        '<div id="bodyContent">'+
        '<p><b>N° Medidor: </b>'+marcadores[i][3]+', '+marcadores[i][4]+'.</p>'+
        '</div>'+
        '</div>';
