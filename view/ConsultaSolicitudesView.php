        	   ...
        	   function load_pendientes(pagina){
                 ...
                 $("#load_pendientes_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=ConsultaSolicitudes&action=pendientes&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
        	   ...
        	   function load_aprobadas(pagina){
                 ...
                 $("#load_aprobadas_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=ConsultaSolicitudes&action=aprobadas&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
        	   ...
        	   function load_anuladas(pagina){
                 ...
                 $("#load_anuladas_registrados").fadeIn('slow');
           	     $.ajax({
           	               ...
           	               url: 'index.php?controller=ConsultaSolicitudes&action=anuladas&search='+search,
           	               type: 'POST',
           	               data: con_datos,
           	               success: function(x){
