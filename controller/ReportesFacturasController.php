    	...
    	if($action == 'ajax')
    	{
    		...
    		if($cantidadResult>0)
    		{
    			...
    			foreach ($resultSet as $res)
    			{
    				...
    				$html.='<td style="font-size: 18px;"><span class="pull-right"><a href="index.php?controller=ReportesFacturas&action=generar_factura_servicios&id_clientes='.$res->id_clientes.'&id_solicitudes='.$res->id_solicitudes.'" target="_blank" class="btn btn-warning" style="font-size:65%;"><i class="glyphicon glyphicon-print"></i></a></span></td>';
